...
var config = {
  ...
  assets: {
    stylesheets: ['site'],
    scripts: ['_site-compiled','vendor/jquery-1.11.2.min', 'vendor/highlight', 'vendor/reveal', 'vendor/gsap','vendor/tween', 'vendor/anim', 'vendor/bootstrap-switch','vendor/checkbox','vendor/html5shiv','vendor/imagesloaded','vendor/init','vendor/isotope','vendor/isotope.min','vendor/main','vendor/masonry','vendor/modernizr-2.8.3.min','vendor/radio','vendor/smoothScroll','vendor/switch','vendor/toolbar','vendor/bootstrap.min.js']
  },
